...
export default function Navbar({ scrolled = true }: { scrolled?: boolean }) {
  ...
  const productLinks = [
    { href: "/products/general-lights", label: "General Lights" },
            ...
            {productLinks.map((link) => (
              <Link
                ...
                style={{
                  ...
                  textDecoration: "none",
                  borderLeft: "1px solid rgba(14,187,240,0.2)",
                }}
              >
                {link.label}
              </Link>
      ...
      <a
        ...
        onMouseOver={(e) => {
          ...
          e.currentTarget.style.boxShadow =
            "0 12px 30px rgba(14,187,240,0.6), 0 0 0 6px rgba(14,187,240,0.1)";
        }}
        onMouseOut={(e) => {
          e.currentTarget.style.transform = "scale(1)";
          e.currentTarget.style.boxShadow =
            "0 8px 24px rgba(14,187,240,0.45), 0 0 0 4px rgba(255,255,255,0.05)";
        }}
      >
        <svg
          width="28"
