  ...
  return (
    <main style={{ background: "var(--paper)", minHeight: "100vh" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "absolute", inset: 0, backgroundImage: `url(https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=1400&q=85)`, backgroundSize: "cover", backgroundPosition: "center 40%", filter: "saturate(0.85) brightness(1.05)", opacity: 0.10 }} />
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <nav style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--text-muted-2)", marginBottom: "1.5rem", display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" as const }}>
            ...
            <span style={{ color: "#0EBBF0" }}>›</span>
            <span style={{ color: "var(--azure-deep)", fontWeight: 600 }}>Lighting Solutions</span>
          </nav>
          ...
          <div className="animate-fade-up">
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.25rem", flexWrap: "wrap" as const }}>
              ...
              <div>
                <p className="section-label" style={{ marginBottom: "0.4rem", color: "#0EBBF0" }}>◆ PILLAR 01 ◆</p>
                <h1 className="section-title" style={{ fontSize: "clamp(2rem,5vw,3.5rem)" }}>Lighting Solutions</h1>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(300px,1fr))", gap: "1.5rem" }}>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>LED Bulbs</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Energy-efficient LED bulbs in a full range of wattages, bases, and color temperatures. Direct retrofit — saving up to 80% on energy.</p>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0EBBF0", flexShrink: 0 }}>
                  <CIcon name="circle" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0EBBF0", textTransform: "uppercase" as const }}>
                  02
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Downlights</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Recessed LED downlights for clean, ceiling-flush installations. Slim, surface-mount, and adjustable gimbal variants.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0EBBF0" }}>VIEW PRODUCTS →</span>
            </div>
            {/* Tube Lights */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0EBBF0", flexShrink: 0 }}>
                  <CIcon name="tube" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0EBBF0", textTransform: "uppercase" as const }}>
                  03
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Tube Lights</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>LED tube replacements for offices, warehouses, and commercial spaces. Instant on, no warmup, no ballast.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0EBBF0" }}>VIEW PRODUCTS →</span>
            </div>
            {/* Flood Lights */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0EBBF0", flexShrink: 0 }}>
                  <CIcon name="sun" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0EBBF0", textTransform: "uppercase" as const }}>
                  04
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Flood Lights</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>High-power outdoor and indoor flood lighting. Cast aluminum housing, tempered glass front, IP65/IP66 rated.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0EBBF0" }}>VIEW PRODUCTS →</span>
            </div>
            {/* Panel Lights */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0EBBF0", flexShrink: 0 }}>
                  <CIcon name="panel" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0EBBF0", textTransform: "uppercase" as const }}>
                  05
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Panel Lights</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Ultra-slim LED panels for offices and commercial spaces. Edge-lit, uniform luminance, fits standard ceiling grids.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0EBBF0" }}>VIEW PRODUCTS →</span>
            </div>
            {/* Track Lights */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0EBBF0", flexShrink: 0 }}>
                  <CIcon name="track" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0EBBF0", textTransform: "uppercase" as const }}>
                  06
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Track Lights</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Modular track lighting for retail, galleries, and restaurants. 1-circuit and 3-circuit track with interchangeable heads.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0EBBF0" }}>VIEW PRODUCTS →</span>
            </div>
          </div>
          ...
          <div ref={addRef} className="reveal" style={{ marginTop: "4rem", textAlign: "center", padding: "3.5rem 2rem", background: "rgba(14,187,240,0.06)", border: "1px solid rgba(14,187,240,0.20)", borderRadius: "16px" }}>
            <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 900, fontSize: "clamp(1.3rem,3vw,2rem)", marginBottom: "0.75rem", color: "var(--text)", letterSpacing: "-0.02em" }}>
              Shop the Full <span className="azure-text">Lighting Solutions</span> Range
            </h3>
