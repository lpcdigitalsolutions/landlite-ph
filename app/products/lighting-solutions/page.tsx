      ...
      <section style={{ position:"relative", overflow:"hidden", paddingTop:"clamp(80px,14vw,130px)", paddingBottom:"clamp(2rem,5vw,4rem)", paddingLeft:"clamp(1.25rem,6vw,5rem)", paddingRight:"clamp(1.25rem,6vw,5rem)", background:"linear-gradient(180deg, var(--paper) 0%, var(--frost) 100%)" }}>
        ...
        <div style={{ maxWidth:"1200px", margin:"0 auto", position:"relative", zIndex:1 }}>
          <nav style={{ fontFamily:"'Exo 2',sans-serif", fontSize:"0.7rem", letterSpacing:"0.18em", textTransform:"uppercase" as const, color:"var(--text-muted-2)", marginBottom:"1.25rem", display:"flex", alignItems:"center", gap:"0.5rem", flexWrap:"wrap" as const }}>
            ...
            <span style={{ color:"#0EBBF0" }}>›</span>
            <span style={{ color:"var(--azure-deep)", fontWeight:600 }}>Lighting Solution</span>
          </nav>
          <div className="animate-fade-up">
            <p className="section-label" style={{ marginBottom:"0.75rem", color:"#0EBBF0" }}>◆ LIGHTING SOLUTION ◆</p>
            <h1 className="section-title" style={{ fontSize:"clamp(2rem,5vw,3.5rem)", marginBottom:"1rem" }}>Lighting Solution <span className="azure-text">Products</span></h1>
            <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"clamp(0.95rem,1.4vw,1.05rem)", color:"var(--text-muted)", lineHeight:1.75, maxWidth:"700px", fontStyle:"italic" }}>From everyday home bulbs to professional architectural systems — Landlite's full lighting range covers every application.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding:"4rem clamp(1.25rem,6vw,5rem) 7rem", background:"var(--paper)" }}>
        <div style={{ maxWidth:"1200px", margin:"0 auto" }}>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))", gap:"1.5rem" }}>
            ...
            <Link key="general-lighting" href="/products/lighting-solutions/general-lighting" ref={addRef as never} className="reveal card-hover"
              ...
              <div style={{ width:"52px", height:"52px", borderRadius:"14px", background:"rgba(14,187,240,0.10)", border:"1px solid rgba(14,187,240,0.30)", display:"flex", alignItems:"center", justifyContent:"center", color:"#0EBBF0", marginBottom:"1.25rem" }}>
                <CIcon name="lightbulb" size={26} />
              </div>
              <h3 style={{ fontFamily:"'Exo 2',sans-serif", fontWeight:700, fontSize:"1.1rem", color:"var(--text)", marginBottom:"0.4rem", letterSpacing:"-0.01em" }}>General Lighting</h3>
              ...
              <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.88rem", color:"var(--text-muted)", lineHeight:1.6, marginBottom:"1rem" }}>Versatile lighting fixtures for every residential and commercial space. Covers ceiling lights, downlights, panel lights,…</p>
              <span style={{ fontFamily:"'Exo 2',sans-serif", fontSize:"0.68rem", fontWeight:700, letterSpacing:"0.2em", color:"#0EBBF0" }}>EXPLORE →</span>
            </Link>

            <Link key="professional-lighting" href="/products/lighting-solutions/professional-lighting" ref={addRef as never} className="reveal card-hover"
              ...
              <div style={{ width:"52px", height:"52px", borderRadius:"14px", background:"rgba(14,187,240,0.10)", border:"1px solid rgba(14,187,240,0.30)", display:"flex", alignItems:"center", justifyContent:"center", color:"#0EBBF0", marginBottom:"1.25rem" }}>
                <CIcon name="sun" size={26} />
              </div>
              <h3 style={{ fontFamily:"'Exo 2',sans-serif", fontWeight:700, fontSize:"1.1rem", color:"var(--text)", marginBottom:"0.4rem", letterSpacing:"-0.01em" }}>Professional Lighting</h3>
              <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.78rem", color:"#0EBBF0", letterSpacing:"0.06em", textTransform:"uppercase" as const, marginBottom:"0.75rem" }}>Architectural Lighting · Industrial and Commercial Lighting · Sports and Outdoor Lighting</p>
              <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.88rem", color:"var(--text-muted)", lineHeight:1.6, marginBottom:"1rem" }}>Architectural, industrial, sports, specialized, and stage lighting systems for demanding professional applications.…</p>
              <span style={{ fontFamily:"'Exo 2',sans-serif", fontSize:"0.68rem", fontWeight:700, letterSpacing:"0.2em", color:"#0EBBF0" }}>EXPLORE →</span>
            </Link>

            <Link key="portable-lighting" href="/products/lighting-solutions/portable-lighting" ref={addRef as never} className="reveal card-hover"
              ...
              <div style={{ width:"52px", height:"52px", borderRadius:"14px", background:"rgba(14,187,240,0.10)", border:"1px solid rgba(14,187,240,0.30)", display:"flex", alignItems:"center", justifyContent:"center", color:"#0EBBF0", marginBottom:"1.25rem" }}>
                <CIcon name="track" size={26} />
              </div>
              <h3 style={{ fontFamily:"'Exo 2',sans-serif", fontWeight:700, fontSize:"1.1rem", color:"var(--text)", marginBottom:"0.4rem", letterSpacing:"-0.01em" }}>Portable Lighting</h3>
              <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.78rem", color:"#0EBBF0", letterSpacing:"0.06em", textTransform:"uppercase" as const, marginBottom:"0.75rem" }}>Plug-in Portable Lights · Rechargeable and Battery-Operated Lights · Worksite and Utility Lights</p>
              <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.88rem", color:"var(--text-muted)", lineHeight:1.6, marginBottom:"1rem" }}>Plug-in, rechargeable, and worksite portable lights for flexible, go-anywhere illumination.…</p>
              <span style={{ fontFamily:"'Exo 2',sans-serif", fontSize:"0.68rem", fontWeight:700, letterSpacing:"0.2em", color:"#0EBBF0" }}>EXPLORE →</span>
            </Link>

            <Link key="lighting-accessories" href="/products/lighting-solutions/lighting-accessories" ref={addRef as never} className="reveal card-hover"
              ...
              <div style={{ width:"52px", height:"52px", borderRadius:"14px", background:"rgba(14,187,240,0.10)", border:"1px solid rgba(14,187,240,0.30)", display:"flex", alignItems:"center", justifyContent:"center", color:"#0EBBF0", marginBottom:"1.25rem" }}>
                <CIcon name="panel" size={26} />
              </div>
              <h3 style={{ fontFamily:"'Exo 2',sans-serif", fontWeight:700, fontSize:"1.1rem", color:"var(--text)", marginBottom:"0.4rem", letterSpacing:"-0.01em" }}>Lighting Accessories</h3>
              <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.78rem", color:"#0EBBF0", letterSpacing:"0.06em", textTransform:"uppercase" as const, marginBottom:"0.75rem" }}>Control and Driver · Mounting and Installation · Electrical and Wiring</p>
              <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.88rem", color:"var(--text-muted)", lineHeight:1.6, marginBottom:"1rem" }}>LED drivers, sensors, mounting hardware, optics, and spare parts to complete and maintain every lighting installation.…</p>
              <span style={{ fontFamily:"'Exo 2',sans-serif", fontSize:"0.68rem", fontWeight:700, letterSpacing:"0.2em", color:"#0EBBF0" }}>EXPLORE →</span>
            </Link>
          </div>
        </div>
