  ...
  return (
    <main style={{ background: "var(--paper)", minHeight: "100vh" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "absolute", inset: 0, backgroundImage: `url(https://images.unsplash.com/photo-1581094288338-2314dddb7ece?w=1400&q=85)`, backgroundSize: "cover", backgroundPosition: "center 40%", filter: "saturate(0.85) brightness(1.05)", opacity: 0.10 }} />
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <nav style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--text-muted-2)", marginBottom: "1.5rem", display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" as const }}>
            ...
            <span style={{ color: "#0880B8" }}>›</span>
            <span style={{ color: "var(--azure-deep)", fontWeight: 600 }}>Wiring Device</span>
          </nav>

          <div className="animate-fade-up">
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.25rem", flexWrap: "wrap" as const }}>
              <div style={{ width: "64px", height: "64px", borderRadius: "16px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.35)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0880B8", flexShrink: 0, boxShadow: "0 4px 14px rgba(14,187,240,0.18)" }}>
                <CIcon name="wiring" size={28} />
              </div>
              <div>
                <p className="section-label" style={{ marginBottom: "0.4rem", color: "#0880B8" }}>◆ PILLAR 02 ◆</p>
                <h1 className="section-title" style={{ fontSize: "clamp(2rem,5vw,3.5rem)" }}>Wiring Device</h1>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(300px,1fr))", gap: "1.5rem" }}>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0880B8", flexShrink: 0 }}>
                  <CIcon name="switch" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0880B8", textTransform: "uppercase" as const }}>
                  01
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Wall Switches</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Tactile rocker switches in single- and multi-gang configurations. Rated 100,000+ operations with brushed-steel or pearl-white facias.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0880B8" }}>VIEW PRODUCTS →</span>
            </div>
            {/* Power Sockets */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0880B8", flexShrink: 0 }}>
                  <CIcon name="socket" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0880B8", textTransform: "uppercase" as const }}>
                  02
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Power Sockets</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Universal and type-specific wall sockets for Philippine voltages. Shutter-protected contacts and surge-resistant terminals.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0880B8" }}>VIEW PRODUCTS →</span>
            </div>
            {/* USB Sockets */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0880B8", flexShrink: 0 }}>
                  <CIcon name="usb" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0880B8", textTransform: "uppercase" as const }}>
                  03
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>USB Sockets</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Wall sockets with built-in USB charging — phone, tablet, and laptop power straight from the wall, no adaptor needed.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0880B8" }}>VIEW PRODUCTS →</span>
            </div>
            {/* Dimmer Switches */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0880B8", flexShrink: 0 }}>
                  <CIcon name="dimmer" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0880B8", textTransform: "uppercase" as const }}>
                  04
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Dimmer Switches</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Smooth dimming control for compatible LED, halogen, and incandescent fixtures. TRIAC, leading-edge, and 0-10V variants.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0880B8" }}>VIEW PRODUCTS →</span>
            </div>
            {/* Switch Plates */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0880B8", flexShrink: 0 }}>
                  <CIcon name="plate" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0880B8", textTransform: "uppercase" as const }}>
                  05
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Switch Plates</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Decorative cover plates in brushed metals, soft-touch plastics, and tempered glass. 1, 2, and 3-gang formats.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0880B8" }}>VIEW PRODUCTS →</span>
            </div>
            {/* Circuit Breakers */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "0.25rem" }}>
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: "rgba(14,187,240,0.10)", border: "1px solid rgba(14,187,240,0.30)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0880B8", flexShrink: 0 }}>
                  <CIcon name="breaker" size={22} />
                </div>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.22em", color: "#0880B8", textTransform: "uppercase" as const }}>
                  06
                </span>
              </div>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Circuit Breakers</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Miniature circuit breakers and RCBOs for safe distribution. DIN-rail mountable, IEC-compliant trip curves.</p>
              <span style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em", color: "#0880B8" }}>VIEW PRODUCTS →</span>
            </div>
          </div>
          ...
          <div ref={addRef} className="reveal" style={{ marginTop: "4rem", textAlign: "center", padding: "3.5rem 2rem", background: "rgba(14,187,240,0.06)", border: "1px solid rgba(14,187,240,0.20)", borderRadius: "16px" }}>
            <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 900, fontSize: "clamp(1.3rem,3vw,2rem)", marginBottom: "0.75rem", color: "var(--text)", letterSpacing: "-0.02em" }}>
              Shop the Full <span className="azure-text">Wiring Device</span> Range
            </h3>
