...
export default function DimmerSwitchesPage() {
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <nav style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--text-muted-2)", marginBottom: "1.25rem", display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" as const }}>
            ...
            <span style={{ color: "#0880B8" }}>›</span>
            <Link href="/products/wiring-device" style={{ color: "var(--text-muted)", textDecoration: "none" }}>Wiring Device</Link>
            <span style={{ color: "#0880B8" }}>›</span>
            <span style={{ color: "var(--azure-deep)", fontWeight: 600 }}>Dimmer Switches</span>
          </nav>
          ...
          <div className="animate-fade-up">
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.25rem", flexWrap: "wrap" as const }}>
              <div style={{ width: "64px", height: "64px", borderRadius: "16px", background: "#0880B818", border: "1px solid #0880B855", display: "flex", alignItems: "center", justifyContent: "center", color: "#0880B8", flexShrink: 0, boxShadow: "0 4px 14px #0880B825" }}>
                <CIcon name="dimmer" size={28} />
              </div>
              <div>
                <p className="section-label" style={{ marginBottom: "0.4rem", color: "#0880B8" }}>◆ WIRING DEVICE ◆</p>
                <h1 className="section-title" style={{ fontSize: "clamp(2rem,5vw,3.5rem)" }}>Dimmer Switches</h1>
              </div>
            </div>
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "clamp(0.95rem,1.4vw,1.1rem)", color: "var(--text-muted)", lineHeight: 1.75, maxWidth: "780px", fontStyle: "italic" }}>
              Smooth dimming control for compatible LED, halogen, and incandescent fixtures. TRIAC, leading-edge, and 0–10V variants for everything from accent lamps to chandeliers.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: "1.5rem" }}>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0880B8", textTransform: "uppercase" as const }}>300W · TRIAC · 220–240V</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Rotary LED Dimmer</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Classic rotary dial with push-on/off click. Trim-pot adjustment to tune the minimum dim level for fussy LEDs.</p>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0880B8", textTransform: "uppercase" as const }}>400W · Leading-edge · Slide bar</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Slide-Flip Dimmer</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Linear slide with snap on/off paddle. Easy to repeat the same brightness night after night.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0880B8", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
            {/* Smart Touch Dimmer */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0880B8", textTransform: "uppercase" as const }}>200W · TRIAC · Wi-Fi</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Smart Touch Dimmer</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>App- and voice-controlled touch surface. Pairs with the Landlite Smart app for schedules and scenes.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0880B8", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
          </div>
      ...
      <section style={{ padding: "4rem clamp(1.25rem,6vw,5rem) 5rem", background: "var(--frost)", borderTop: "1px solid rgba(5,13,26,0.05)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div ref={addRef} className="reveal" style={{ marginBottom: "1.75rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
            <div style={{ width: "3px", height: "26px", borderRadius: "2px", background: "linear-gradient(180deg, #0880B8, var(--azure-deep))" }} />
            <h2 style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.95rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--azure-deep)" }}>More in Wiring Device</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(200px,1fr))", gap: "0.75rem" }}>
              <Link key="wall-switches" href="/products/wiring-device/wall-switches"
                ...
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Wall Switches</span>
                <span style={{ marginLeft: "auto", color: "#0880B8", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="power-sockets" href="/products/wiring-device/power-sockets"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0880B8", display: "flex", alignItems: "center" }}><CIcon name="socket" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Power Sockets</span>
                <span style={{ marginLeft: "auto", color: "#0880B8", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="usb-sockets" href="/products/wiring-device/usb-sockets"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0880B8", display: "flex", alignItems: "center" }}><CIcon name="usb" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>USB Sockets</span>
                <span style={{ marginLeft: "auto", color: "#0880B8", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="switch-plates" href="/products/wiring-device/switch-plates"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0880B8", display: "flex", alignItems: "center" }}><CIcon name="plate" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Switch Plates</span>
                <span style={{ marginLeft: "auto", color: "#0880B8", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="circuit-breakers" href="/products/wiring-device/circuit-breakers"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0880B8", display: "flex", alignItems: "center" }}><CIcon name="breaker" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Circuit Breakers</span>
                <span style={{ marginLeft: "auto", color: "#0880B8", fontSize: "0.7rem" }}>→</span>
              </Link>
          </div>
        </div>
