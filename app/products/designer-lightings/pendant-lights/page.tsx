...
export default function PendantLightsPage() {
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <nav style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--text-muted-2)", marginBottom: "1.25rem", display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" as const }}>
            ...
            <span style={{ color: "#0EBBF0" }}>›</span>
            <span style={{ color: "var(--azure-deep)", fontWeight: 600 }}>Pendant Lights</span>
          </nav>
          ...
          <div className="animate-fade-up">
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.25rem", flexWrap: "wrap" as const }}>
              <div style={{ width: "64px", height: "64px", borderRadius: "16px", background: "#0EBBF018", border: "1px solid #0EBBF055", display: "flex", alignItems: "center", justifyContent: "center", color: "#0EBBF0", flexShrink: 0, boxShadow: "0 4px 14px #0EBBF025" }}>
                <CIcon name="pendant" size={28} />
              </div>
              <div>
                <p className="section-label" style={{ marginBottom: "0.4rem", color: "#0EBBF0" }}>◆ DESIGNER LIGHTINGS ◆</p>
                <h1 className="section-title" style={{ fontSize: "clamp(2rem,5vw,3.5rem)" }}>Pendant Lights</h1>
              </div>
            </div>
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "clamp(0.95rem,1.4vw,1.1rem)", color: "var(--text-muted)", lineHeight: 1.75, maxWidth: "780px", fontStyle: "italic" }}>
              Hanging fixtures for dining tables, kitchen islands, and over-counter task lighting. Single-shade and cluster configurations with adjustable cord drops.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: "1.5rem" }}>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>E27 · Ø30cm · Black steel + brass interior</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Industrial Cone Pendant</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Steel cone with a polished brass inner that warms the downcast pool of light. Cafe-counter classic.</p>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>E27 · Ø45cm · Hand-woven rattan</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Rattan Dome Pendant</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Tropical hand-woven dome that throws soft slatted shadows on the ceiling.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
            {/* Smoked Glass Orb */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>E27 · Ø25cm · Smoked grey glass + brass</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Smoked Glass Orb</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Hand-blown smoked-glass globe on a slim brass stem. Reads minimal at any height.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
          </div>
      ...
      <section style={{ padding: "4rem clamp(1.25rem,6vw,5rem) 5rem", background: "var(--frost)", borderTop: "1px solid rgba(5,13,26,0.05)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(200px,1fr))", gap: "0.75rem" }}>
              <Link key="chandeliers" href="/products/designer-lightings/chandeliers"
                ...
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="chandelier" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Chandeliers</span>
