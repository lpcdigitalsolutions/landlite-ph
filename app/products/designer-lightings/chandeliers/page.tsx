      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <nav style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--text-muted-2)", marginBottom: "1.25rem", display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" as const }}>
            ...
            <span style={{ color: "#0EBBF0" }}>›</span>
            <Link href="/products/designer-lightings" style={{ color: "var(--text-muted)", textDecoration: "none" }}>Designer Lightings</Link>
            <span style={{ color: "#0EBBF0" }}>›</span>
            <span style={{ color: "var(--azure-deep)", fontWeight: 600 }}>Chandeliers</span>
          </nav>
          ...
          <div className="animate-fade-up">
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.25rem", flexWrap: "wrap" as const }}>
              <div style={{ width: "64px", height: "64px", borderRadius: "16px", background: "#0EBBF018", border: "1px solid #0EBBF055", display: "flex", alignItems: "center", justifyContent: "center", color: "#0EBBF0", flexShrink: 0, boxShadow: "0 4px 14px #0EBBF025" }}>
                <CIcon name="chandelier" size={28} />
              </div>
              <div>
                <p className="section-label" style={{ marginBottom: "0.4rem", color: "#0EBBF0" }}>◆ DESIGNER LIGHTINGS ◆</p>
                <h1 className="section-title" style={{ fontSize: "clamp(2rem,5vw,3.5rem)" }}>Chandeliers</h1>
              </div>
            </div>
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "clamp(0.95rem,1.4vw,1.1rem)", color: "var(--text-muted)", lineHeight: 1.75, maxWidth: "780px", fontStyle: "italic" }}>
              Statement ceiling fixtures for living rooms, dining halls, and hotel lobbies. From traditional crystal to modern brass ring designs — sized for ceilings from 2.7m up.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: "1.5rem" }}>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>8× E14 · Ø80cm · Chrome + clear crystal</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>8-Arm Crystal Chandelier</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Traditional 8-arm silhouette with K9 crystal pendants and chrome arms. Centerpiece of a dining or formal living room.</p>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>60W LED · Ø100cm · Brushed brass</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Modern Ring Chandelier</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Single brushed-brass halo with integrated dimmable LED edge. Reads as architecture, not jewelry.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
            {/* Capiz Shell Tier Pendant */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>5× E27 · Ø60cm · Natural capiz</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Capiz Shell Tier Pendant</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Filipino capiz-shell tiers that catch the light. Honest local craft for a modern interior.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
          </div>
      ...
      <section style={{ padding: "4rem clamp(1.25rem,6vw,5rem) 5rem", background: "var(--frost)", borderTop: "1px solid rgba(5,13,26,0.05)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div ref={addRef} className="reveal" style={{ marginBottom: "1.75rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
            <div style={{ width: "3px", height: "26px", borderRadius: "2px", background: "linear-gradient(180deg, #0EBBF0, var(--azure-deep))" }} />
            <h2 style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.95rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--azure-deep)" }}>More in Designer Lightings</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(200px,1fr))", gap: "0.75rem" }}>
              <Link key="pendant-lights" href="/products/designer-lightings/pendant-lights"
                ...
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="pendant" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Pendant Lights</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="wall-sconces" href="/products/designer-lightings/wall-sconces"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="sconce" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Wall Sconces</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="floor-lamps" href="/products/designer-lightings/floor-lamps"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="floor-lamp" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Floor Lamps</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="table-lamps" href="/products/designer-lightings/table-lamps"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="table-lamp" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Table Lamps</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="strip-lights" href="/products/designer-lightings/strip-lights"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="strip" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Strip Lights</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
          </div>
        </div>
