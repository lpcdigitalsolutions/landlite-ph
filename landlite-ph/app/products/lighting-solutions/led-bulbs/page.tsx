      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <nav style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--text-muted-2)", marginBottom: "1.25rem", display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" as const }}>
            ...
            <span style={{ color: "#0EBBF0" }}>›</span>
            <Link href="/products/lighting-solutions" style={{ color: "var(--text-muted)", textDecoration: "none" }}>Lighting Solutions</Link>
            <span style={{ color: "#0EBBF0" }}>›</span>
            <span style={{ color: "var(--azure-deep)", fontWeight: 600 }}>LED Bulbs</span>
          </nav>

          {/* Title block */}
          <div className="animate-fade-up">
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.25rem", flexWrap: "wrap" as const }}>
              <div style={{ width: "64px", height: "64px", borderRadius: "16px", background: "#0EBBF018", border: "1px solid #0EBBF055", display: "flex", alignItems: "center", justifyContent: "center", color: "#0EBBF0", flexShrink: 0, boxShadow: "0 4px 14px #0EBBF025" }}>
                <CIcon name="lightbulb" size={28} />
              </div>
              <div>
                <p className="section-label" style={{ marginBottom: "0.4rem", color: "#0EBBF0" }}>◆ LIGHTING SOLUTIONS ◆</p>
                <h1 className="section-title" style={{ fontSize: "clamp(2rem,5vw,3.5rem)" }}>LED Bulbs</h1>
              </div>
            </div>
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "clamp(0.95rem,1.4vw,1.1rem)", color: "var(--text-muted)", lineHeight: 1.75, maxWidth: "780px", fontStyle: "italic" }}>
              Energy-efficient LED bulbs in a full range of wattages, bases, and color temperatures. Direct retrofit for incandescent and CFL fixtures — saving up to 80% on energy with a 25,000-hour rated lifespan.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "5rem clamp(1.25rem,6vw,5rem) 6rem", background: "var(--paper)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div ref={addRef} className="reveal" style={{ marginBottom: "2.5rem", display: "flex", alignItems: "center", gap: "0.75rem", flexWrap: "wrap" as const }}>
            <div style={{ width: "3px", height: "26px", borderRadius: "2px", background: "linear-gradient(180deg, #0EBBF0, var(--azure-deep))" }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: "1.5rem" }}>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              {/* Placeholder image */}
              <div style={{ width: "100%", height: "140px", borderRadius: "8px", background: `linear-gradient(135deg, #0EBBF012, #0EBBF02A 50%, #0EBBF012)`, border: `1px solid #0EBBF030`, display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", inset: 0, background: `radial-gradient(circle at 50% 30%, #0EBBF055 0%, transparent 60%)`, opacity: 0.65 }} />
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 900, fontSize: "3rem", letterSpacing: "-0.04em", color: "#0EBBF0", opacity: 0.4, position: "relative" }}>01</span>
              </div>
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>E27 · 800lm · 6500K Daylight</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Landlite 9W LED Bulb</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Everyday A-shape replacement for a 60W incandescent. Instant-on, no flicker, full output from the first second.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
            {/* Landlite 12W LED Bulb */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ width: "100%", height: "140px", borderRadius: "8px", background: `linear-gradient(135deg, #0EBBF012, #0EBBF02A 50%, #0EBBF012)`, border: `1px solid #0EBBF030`, display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", inset: 0, background: `radial-gradient(circle at 50% 30%, #0EBBF055 0%, transparent 60%)`, opacity: 0.65 }} />
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 900, fontSize: "3rem", letterSpacing: "-0.04em", color: "#0EBBF0", opacity: 0.4, position: "relative" }}>02</span>
              </div>
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>E27 · 1,100lm · 2700K Warm White</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Landlite 12W LED Bulb</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Higher-output A-shape for living rooms and hallways. Cozy warm tone that mimics the look of a traditional filament bulb.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
            {/* Landlite 5W Candle Bulb */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <div style={{ width: "100%", height: "140px", borderRadius: "8px", background: `linear-gradient(135deg, #0EBBF012, #0EBBF02A 50%, #0EBBF012)`, border: `1px solid #0EBBF030`, display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", inset: 0, background: `radial-gradient(circle at 50% 30%, #0EBBF055 0%, transparent 60%)`, opacity: 0.65 }} />
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 900, fontSize: "3rem", letterSpacing: "-0.04em", color: "#0EBBF0", opacity: 0.4, position: "relative" }}>03</span>
              </div>
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>E14 · 470lm · 3000K Soft White</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Landlite 5W Candle Bulb</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Decorative candle silhouette for chandeliers and pendants. Pairs with most Designer Lightings fixtures in the LPC range.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
            {/* Landlite 15W LED Bulb */}
            <div ref={addRef} className="reveal card-hover"
              style={{ padding: "1.5rem", borderRadius: "12px", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", boxShadow: "0 2px 8px rgba(5,13,26,0.06)", display: "flex", flexDirection: "column" as const, gap: "0.75rem", animationDelay: "0.24s" }}>
              {/* Placeholder image */}
              <div style={{ width: "100%", height: "140px", borderRadius: "8px", background: `linear-gradient(135deg, #0EBBF012, #0EBBF02A 50%, #0EBBF012)`, border: `1px solid #0EBBF030`, display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", inset: 0, background: `radial-gradient(circle at 50% 30%, #0EBBF055 0%, transparent 60%)`, opacity: 0.65 }} />
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 900, fontSize: "3rem", letterSpacing: "-0.04em", color: "#0EBBF0", opacity: 0.4, position: "relative" }}>04</span>
              </div>
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>E27 · 1,400lm · 4000K Cool White</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>Landlite 15W LED Bulb</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>High-lumen output for kitchens, workshops, and outdoor porches. Neutral white reads sharp without being clinical.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
          </div>
      ...
      <section style={{ padding: "4rem clamp(1.25rem,6vw,5rem) 5rem", background: "var(--frost)", borderTop: "1px solid rgba(5,13,26,0.05)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div ref={addRef} className="reveal" style={{ marginBottom: "1.75rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
            <div style={{ width: "3px", height: "26px", borderRadius: "2px", background: "linear-gradient(180deg, #0EBBF0, var(--azure-deep))" }} />
            <h2 style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.95rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--azure-deep)" }}>More in Lighting Solutions</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(200px,1fr))", gap: "0.75rem" }}>
              <Link key="downlights" href="/products/lighting-solutions/downlights"
                ...
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="circle" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Downlights</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="tube-lights" href="/products/lighting-solutions/tube-lights"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="tube" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Tube Lights</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="flood-lights" href="/products/lighting-solutions/flood-lights"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="sun" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Flood Lights</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="panel-lights" href="/products/lighting-solutions/panel-lights"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="panel" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Panel Lights</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
              <Link key="track-lights" href="/products/lighting-solutions/track-lights"
                style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.85rem 1rem", background: "var(--paper)", border: "1px solid rgba(5,13,26,0.06)", borderRadius: "8px", textDecoration: "none", boxShadow: "0 1px 3px rgba(5,13,26,0.04)", transition: "all 0.25s ease" }}
                onMouseOver={(e) => { e.currentTarget.style.borderColor = "rgba(14,187,240,0.40)"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 20px rgba(5,13,26,0.08)"; }}
                onMouseOut={(e) => { e.currentTarget.style.borderColor = "rgba(5,13,26,0.06)"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(5,13,26,0.04)"; }}>
                <span style={{ color: "#0EBBF0", display: "flex", alignItems: "center" }}><CIcon name="track" size={18} /></span>
                <span style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.85rem", color: "var(--text)" }}>Track Lights</span>
                <span style={{ marginLeft: "auto", color: "#0EBBF0", fontSize: "0.7rem" }}>→</span>
              </Link>
          </div>
        </div>
