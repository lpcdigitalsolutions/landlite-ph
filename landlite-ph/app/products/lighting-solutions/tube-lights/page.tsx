...
export default function TubeLightsPage() {
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <nav style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--text-muted-2)", marginBottom: "1.25rem", display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" as const }}>
            ...
            <span style={{ color: "#0EBBF0" }}>›</span>
            <span style={{ color: "var(--azure-deep)", fontWeight: 600 }}>Tube Lights</span>
          </nav>
          ...
          <div className="animate-fade-up">
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.25rem", flexWrap: "wrap" as const }}>
              <div style={{ width: "64px", height: "64px", borderRadius: "16px", background: "#0EBBF018", border: "1px solid #0EBBF055", display: "flex", alignItems: "center", justifyContent: "center", color: "#0EBBF0", flexShrink: 0, boxShadow: "0 4px 14px #0EBBF025" }}>
                <CIcon name="tube" size={28} />
              </div>
              <div>
                <p className="section-label" style={{ marginBottom: "0.4rem", color: "#0EBBF0" }}>◆ LIGHTING SOLUTIONS ◆</p>
                <h1 className="section-title" style={{ fontSize: "clamp(2rem,5vw,3.5rem)" }}>Tube Lights</h1>
              </div>
            </div>
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "clamp(0.95rem,1.4vw,1.1rem)", color: "var(--text-muted)", lineHeight: 1.75, maxWidth: "780px", fontStyle: "italic" }}>
              LED tube replacements for offices, warehouses, and commercial spaces. Direct drop-in for T8 and T5 fixtures — instant on, no warmup, no ballast.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: "1.5rem" }}>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>9W · 1,000lm · 4000K</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>T8 LED Tube — 2ft</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Half-length T8 retrofit for bathrooms, kitchenettes, and short-fixture installs. Single-end power compatible.</p>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>18W · 2,000lm · 4000K</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>T8 LED Tube — 4ft</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Standard 4-foot office tube. Ballast-bypass wiring; double-ended G13 base.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
            {/* T5 LED Tube — 4ft */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0EBBF0", textTransform: "uppercase" as const }}>22W · 2,400lm · 6500K</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>T5 LED Tube — 4ft</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Slim-diameter T5 tube for commercial high-bay or backlit signage. Cool daylight tone for maximum visibility.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0EBBF0", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
          </div>
