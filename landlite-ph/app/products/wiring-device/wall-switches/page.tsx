...
export default function WallSwitchesPage() {
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <nav style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "var(--text-muted-2)", marginBottom: "1.25rem", display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" as const }}>
            ...
            <span style={{ color: "#0880B8" }}>›</span>
            <span style={{ color: "var(--azure-deep)", fontWeight: 600 }}>Wall Switches</span>
          </nav>
          ...
          <div className="animate-fade-up">
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.25rem", flexWrap: "wrap" as const }}>
              <div style={{ width: "64px", height: "64px", borderRadius: "16px", background: "#0880B818", border: "1px solid #0880B855", display: "flex", alignItems: "center", justifyContent: "center", color: "#0880B8", flexShrink: 0, boxShadow: "0 4px 14px #0880B825" }}>
                <CIcon name="switch" size={28} />
              </div>
              <div>
                <p className="section-label" style={{ marginBottom: "0.4rem", color: "#0880B8" }}>◆ WIRING DEVICE ◆</p>
                <h1 className="section-title" style={{ fontSize: "clamp(2rem,5vw,3.5rem)" }}>Wall Switches</h1>
              </div>
            </div>
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "clamp(0.95rem,1.4vw,1.1rem)", color: "var(--text-muted)", lineHeight: 1.75, maxWidth: "780px", fontStyle: "italic" }}>
              Tactile rocker switches in single- and multi-gang configurations. Robust silver-contact mechanism rated for 100,000+ operations, with brushed-steel or pearl-white facias.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: "1.5rem" }}>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0880B8", textTransform: "uppercase" as const }}>16A · 1-way · Pearl white</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>1-Gang Rocker Switch</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Single-circuit rocker for a typical room light. Clip-in module fits standard 86mm UK wall boxes.</p>
            ...
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0880B8", textTransform: "uppercase" as const }}>16A · 1-way · Pearl white</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>2-Gang Rocker Switch</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Two independent rockers in a single faceplate — paired ceiling + lamp control with one device.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0880B8", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
            {/* 3-Gang 2-Way Switch */}
            <div ref={addRef} className="reveal card-hover"
              ...
              <p style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 600, fontSize: "0.62rem", letterSpacing: "0.2em", color: "#0880B8", textTransform: "uppercase" as const }}>16A · 2-way · Brushed steel</p>
              <h3 style={{ fontFamily: "'Exo 2',sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text)", letterSpacing: "-0.01em" }}>3-Gang 2-Way Switch</h3>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.65, flex: 1 }}>Multi-gang switch with 2-way wiring on each rocker. Designed for hallways and staircases.</p>
              <a href="https://landlitephilcorp.com/collections/all" target="_blank" rel="noopener noreferrer"
                style={{ fontFamily: "'Exo 2',sans-serif", fontSize: "0.68rem", fontWeight: 700, color: "#0880B8", letterSpacing: "0.2em", textDecoration: "none" }}>SPEC SHEET →</a>
            </div>
          </div>
